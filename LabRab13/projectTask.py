...
#Кучерявенко Роман
new_csv1 = [
     {"Прізвище": "Сидоренко", "Ім'я": "Оксана", "Адреса": "вул. Герасима Кондратьева, 136", "Номер школи": 1, "Клас": 11, "id": "0011"},
     {"Прізвище": "Білов", "Ім'я": "Максим", "Адреса": "пр. Свободи, 18", "Номер школи": 17, "Клас": 11, "id": "0174"}
 ]
json_to_csv1('student.csv', 'student.json', new_csv1)
